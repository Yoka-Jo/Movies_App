...
class GetUpcomingTvShowsEpisodesUseCase extends UseCase<List<TvShow>,NoParams>{
  final TvShowAppRepository tvShowAppRepository;

  GetUpcomingTvShowsEpisodesUseCase(this.tvShowAppRepository);
  @override
  Future<Either<Failure, List<TvShow>>> call(NoParams params) async{
    return await tvShowAppRepository.getUpcomingShowsEpisodes();
  }
